...
function dataDidLoad(error,dataDictionaryFile){
   ...
   // map["dragPan"].disable()
    ...
    map.on('load', function() {
       ...
       d3.selectAll(".mapboxgl-ctrl").style("margin","0px 0px 0px 0px")
       d3.selectAll(".geocoder-pin-right").style("top","3px")
...
d3.select("."+panel).append("div").html("&#10005").style("color",lineColor).style("font-size","40px")
  ...
  console.log(document.getElementsByClassName("mapboxgl-ctrl-geocoder").value)
  console.log(document.getElementsByClassName("mapbox-directions-origin").value)
  console.log(document.getElementsByClassName("mapboxgl-ctrl-geocoder").value)
    //console.log(geoids)
...
function addPolygons(map,geoids){
    var filter = ["in","AFFGEOID"].concat(geoids);
    map.setFilter("bg-hover-highlight", filter);           
  //  map.setPaintProperty("bg-hover-highlight","fill-color",lineColor)
